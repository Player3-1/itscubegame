...
export const COLORS = {
  ...
  slowBlock: '#ff69b4', // Pembe - yavaşlatıcı blok
  normalBlock: '#0099ff', // Mavi - normal hız bloğu
  fastBlock: '#00cc66', // Yeşil - hızlandırıcı blok
  orb: '#ffff00', // Sarı - yuvarlak orb
  gravityOrb: '#3b82f6' // Mavi - yer çekimi değiştiren orb
};
